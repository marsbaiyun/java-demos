...
/**
 * Description：There is a queue of N cars waiting at a filling station. There are three fuel dispensers at the station, labeled X, Y and Z, respectively. Each dispenser has some finite amount of fuel in it; at all times the amount of available fuel is clearly displayed on each dispenser.
    ...
    Write a function:
    class Solution { public int solution(int[] A, int X, int Y, int Z); }
...
//        System.out.println(solution(new int[]{5, 6, 5}, 10, 10, 1));
    }
